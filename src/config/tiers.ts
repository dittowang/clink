...
export const TIERS: Readonly<Record<TierId, TierDef>> = {
  1:  { id: 1,  key: 'juiceBox',   massKg: MASS_KG[1],  radius: 0.026, height: 0.105, material: 'paper',    cold: false, hue: 35 },
  ...
  6:  { id: 6,  key: 'masonJar',   massKg: MASS_KG[6],  radius: 0.048, height: 0.170, material: 'glass',    cold: true,  hue: 55 },
